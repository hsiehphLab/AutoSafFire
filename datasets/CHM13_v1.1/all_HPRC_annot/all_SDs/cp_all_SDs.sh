...
for FILE in /panfs/jay/groups/7/hsiehph/shared/hsiehph_shared/wgac_benson/genomicSDsFiles/*.tab; do
	...
	cut -f 1-3 ${sample_name}_temp.txt > ${sample_name}_T2T_annot.bed
...
rm /home/hsiehph/shared/javid017-home/jobs/AutoSafFire/datasets/CHM13_v1.1/all_HPRC_annot/all_SDs/*.txt
